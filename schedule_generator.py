...
programme = {
    ...
    7: {
        'алг_геом': 5, 'укр_мова': 2, 'укр_літ': 2, 'англ': 3, 'історія': 2,
    ...
    10: {
        'укр_мова': 2, 'укр_літ': 2, 'англ': 3, 'матем': 4,
...
teachers = {
    'матем': ['Ірина Петрівна', 'Галина Степанівна'],
    'англ': ['Марта Василівна', 'Олег Ігорович'],
    'укр_мова': ['Оксана Іванівна'],
    'укр_літ': ['Оксана Іванівна'],
    'історія': ['Юрій Миколайович'],
    'алг_геом': ['Світлана Василівна'],
    'алг': ['Світлана Василівна'],
    'геом': ['Світлана Василівна'],
    'природ': ['Леся Віталіївна'],
    'біологія': ['Олена Степанівна'],
    'фізика': ['Інна Анатоліївна'],
    'географія': ['Марина Сергіївна'],
    'інформатика': ['Тетяна Юріївна'],
    'труд': ['Андрій Петрович'],
    'мистецтво': ['Катерина Олександрівна'],
    'здоров’я': ['Ірина Вікторівна'],
    'іст_укр': ['Юрій Миколайович'],
    'іст_світ': ['Ірина Вікторівна'],
    'право': ['Олег Ігорович'],
    'захист_укр': ['Петро Дмитрович'],
    'фізра': ['Олексій Андрійович'],
    'хімія': ['Ірина Вікторівна']
}
