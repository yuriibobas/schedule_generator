...
teachers = {
    ...
    'укр_мова': ['Оксана Іванівна', 'Марія Михайлівна'],
    'укр_літ': ['Оксана Іванівна', 'Марія Михайлівна'],
    ...
    'фізика': ['Інна Анатоліївна', 'Олег Олексійович'],
    'географія': ['Марина Сергіївна', 'Ігор Миколайович'],
    'інформатика': ['Тетяна Юріївна', 'Олена Юріївна'],
    'труд': ['Андрій Петрович', 'Марина Сергіївна'],
    'мистецтво': ['Катерина Олександрівна'],
    'здоров’я': ['Ірина Вікторівна'],
    'іст_укр': ['Юрій Миколайович', 'Людмила Іванівна'],
    'іст_світ': ['Ірина Вікторівна', 'Людмила Іванівна'],
    'право': ['Олег Ігорович'],
    'захист_укр': ['Петро Дмитрович'],
    'фізра': ['Олексій Андрійович', 'Юрій Олегович'],
    'хімія': ['Ірина Вікторівна', 'Галина Ігорівна']
}
